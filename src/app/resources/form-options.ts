export const STATES_OPTIONS: Array<{ id: string, value: string }> = [
    { id: 'AL', value: 'Alabama' },
    { id: 'AK', value: 'Alaska' },
    { id: 'AZ', value: 'Arizona' },
...
export const ROOMSIZE_OPTIONS: Array<{ value: string, label: string }> = [
  { value: 'business-suite', label: 'Business Suite' },  
  { value: 'presidential-suite', label: 'Presidential Suite' }
];

export const EXTRAS_OPTIONS: Array<{id: string, value: string}> =  [
  { id: 'extraBreakfast', value: 'Breakfast' },
  { id: 'extraTV', value: 'TV' },
  { id: 'extraWiFi', value: 'WiFi' },
  { id: 'extraParking', value: 'Parking' },
  { id: 'extraBalcony', value: 'Balcony' }
];

export const PAYMENT_OPTIONS: Array<{id: string, value: string}> =  [
...
export const TAGS_OPTIONS: string[] = ['hotel', 'booking', 'labtest', 'angular', 'material'];